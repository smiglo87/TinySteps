...
public class PickerPopper : MonoBehaviour 
{
	...
	UIDragScrollView 	_dragContents;
	...
	void Start ()
	{
		...
		_dragContents = pickerColliderObject.GetComponent ( typeof ( UIDragScrollView ) ) as UIDragScrollView;
	...
	public IEnumerator OpenPicker ()
	{
		...
		/*_clipRangeTween.onFinished.Clear ();
		_clipRangeTween.onFinished.Add ( new EventDelegate ( OnTweenClipRangeFinished ) );*/
		/*if ( _clipRangeTween.onFinished != null )
			_clipRangeTween.onFinished.Clear ();*/
